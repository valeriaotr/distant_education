...
public class GetCommonTasksAmountQueryHandler : IRequestHandler<GetCommonTasksAmountQuery,int>
{
    private readonly IPersonalStatisticsRepository _statisticsRepository;
    
    public GetCommonTasksAmountQueryHandler(IPersonalStatisticsRepository statisticsRepository)
    {
        _statisticsRepository = statisticsRepository;
    }
    
    public async Task<int> Handle(GetCommonTasksAmountQuery request, CancellationToken cancellationToken)
    {
        ...
        return statisticsModel.GetCommonAmountOfTasks();
    }
}